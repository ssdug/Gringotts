    ...
    public partial class InitialState : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ReceiptSourceId = c.Int(),
                        Discriminator = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => new { t.TransactionId, t.AccountId })
                .ForeignKey("dbo.Accounts", t => t.AccountId)
                .ForeignKey("dbo.TransactionBatches", t => t.TransactionBatchId)
                ...
                .ForeignKey("dbo.ReceiptSources", t => t.ReceiptSourceId)
                .Index(t => t.AccountId)
                .Index(t => t.TransactionBatchId)
                .Index(t => t.TransactionSubTypeId)
                .Index(t => t.FundId)
                .Index(t => t.OrganizationId)
                .Index(t => t.PayeeId)
                .Index(t => t.ExpenseCategoryId)
                .Index(t => t.ReceiptSourceId);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TransactionBatches", t => t.ParentId)
                .ForeignKey("dbo.Funds", t => t.FundId)
                .ForeignKey("dbo.Organizations", t => t.OrganizationId)
                .ForeignKey("dbo.TransactionSubTypes", t => t.TransactionSubTypeId)
                .ForeignKey("dbo.Transactions", t => new { t.TriggerId, t.TriggerAccountId })
                .ForeignKey("dbo.Payees", t => t.PayeeId)
                .ForeignKey("dbo.Accounts", t => t.FromAccountId)
                .ForeignKey("dbo.Accounts", t => t.ToAccountId)
                .Index(t => t.TransactionSubTypeId)
                .Index(t => new { t.TriggerId, t.TriggerAccountId })
                .Index(t => t.ParentId)
                .Index(t => t.FundId)
                .Index(t => t.OrganizationId)
                .Index(t => t.PayeeId)
                ...
                c => new
                    {
                        ...
                        State = c.String(nullable: false, maxLength: 255),
                        PostalCode = c.String(nullable: false, maxLength: 255),
                        IsUserSelectable = c.Boolean(nullable: false),
                        OrganizationId = c.Int(nullable: false),
                        IsActive = c.Boolean(nullable: false),
                        Created = c.DateTime(nullable: false),
                        CreatedBy = c.String(nullable: false, maxLength: 255),
