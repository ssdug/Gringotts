...
namespace Wiz.Gringotts.UIWeb.Infrastructure
{
    public static class LinkBuilder
    {
        public static string BuildUrlFromExpression<TController>(RequestContext requestContext, RouteCollection routes,
            Expression<Action<TController>> action) where TController : ControllerBase
        {
        ...
        private static string BuildUrlFromExpressionImpl<TController>(RequestContext context, RouteCollection routeCollection, Expression<Action<TController>> action) where TController : ControllerBase
        {
        ...
        private static RouteValueDictionary GetRouteValuesFromExpression<TController>(Expression<Action<TController>> action) where TController : ControllerBase
        {
            if (action == null)
            {
